...
const specs = {
  ...
  Task: {
    delegate: 'task',
    fields: ['title', 'taskType', 'frequency', 'status', 'assignedTo', 'createdBy', 'createdByRole', 'completedBy', 'completedAt', 'description', 'remarks', 'nextFollowup', 'comments', 'seenByOwner', 'seenAt', 'createdAt'],
    populate: {
